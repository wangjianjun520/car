      ...
      getCurrent(){
          control.getCurrent().then(Response=>{  
            ...
            Response.data.server.forEach((data,index)=>{
               ...
               if (data.id ==0) {
                 if (data.running==0) {
                   this.tableData[0].chi=0
                   this.checkServer(0,0)
                 }else if (data.running==1) {
                   this.tableData[0].chi=1
                   this.checkServer(0,1)
                 }else if (data.running==2) {
                   this.tableData[0].chi=2
                   this.checkServer(0,2)
                 }else if (data.running==3) {
                   this.tableData[0].chi=3
                   this.checkServer(0,3)
                 }
               }else if (data.id ==1) {
                 if (data.running==0) {
                   this.tableData[1].chi=0
                    this.checkServer(1,0)
                 }else if (data.running==1) {
                   this.tableData[1].chi=1
                    this.checkServer(1,1)
                 }else if (data.running==2) {
                   this.tableData[1].chi=2
                    this.checkServer(1,2)
                 }else if (data.running==3) {
                   this.tableData[1].chi=3
                    this.checkServer(1,3)
                 }
                 
               }else if (data.id ==2) {
                  if (data.running==0) {
                     this.tableData[2].chi=0
                    this.checkServer(2,0)
                 }else if (data.running==1) {
                    this.tableData[2].chi=1
                    this.checkServer(2,1)
                 }else if (data.running==2) {
                    this.tableData[2].chi=2
                    this.checkServer(2,2)
                 }else if (data.running==3) {
                    this.tableData[2].chi=3
                    this.checkServer(2,3)
                 }
